...
namespace Assg.Migrations
{
    ...
    [Migration("20241227152800_Initial")]
            ...
            modelBuilder.Entity("Assg.Models.StudentModels.ChatQuestion", b =>
                {
                    ...
                    b.Property<int?>("ChapterContentId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assg.Models.StudentModels.ChatQuestion", b =>
                {
                    ...
                    b.HasOne("Assg.Models.StudentModels.ChapterContent", null)
                        .WithMany("ChatQuestion")
                        .HasForeignKey("ChapterContentId1");
